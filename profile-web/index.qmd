---
# title: "WDI Economy Statistical Profile"
format: html
server: shiny
...
# Version: 1.0.0
# Notes: mock-up version with test data, deploymenent complteted to internal server at 
# https://datanalytics-int.worldbank.org/wdi-economy-profile/
---
...
uiOutput("header_section")

uiOutput("country_summary")

uiOutput("classifications")

uiOutput("survey_charts")

uiOutput("concepts_standards")

uiOutput("nso_info")

uiOutput("other_resources")
